...
use Hydra\Component\ExpressionLanguage\Tests\Fixtures\TestProvider;

class ExpressionLanguageTest extends \PHPUnit_Framework_TestCase
{
    public function testCachedParse()
    {
        $cacheMock = $this->getMock('Hydra\Component\ExpressionLanguage\ParserCache\ParserCacheInterface');
        ...
        $cacheMock
            ...
            ->method('save')
            ->with('1 + 1//', $this->isInstanceOf('Hydra\Component\ExpressionLanguage\ParsedExpression'))
